...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Stmik Kharisma Karawang">
    <meta name="description" content="WebPlikasi">
    <meta name="keywords" content="Stmik,Karawang,kharisma,webplikasi,corona">
    <meta name="author" content="Webplikasi Dev">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>assets/images/logo-kharisma.png">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>STMIK Kharisma Karawang</title>
